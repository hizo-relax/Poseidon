---
title: 原生JS实现上传图片控件
description: 利用html+css+javascript实现的一个上传图片控件，可支持预览
---
...
![](markdown/images/upload-02.png)
![](markdown/images/upload-03.png)
